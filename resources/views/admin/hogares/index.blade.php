...
@section('panel-content')
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-gray-700">Instituciones</h2>

        {{--  Mensaje de éxito  vejo
        @if (session('success'))
                        ...
                        <tr class="hover:bg-gray-50 transition border-b">
                            ...
                            <td class="p-3">
                                <div class="flex justify-center gap-2">
                                    ...
                                    {{-- Editar --}}
                                    <a href="{{ route('admin.instituciones.edit', $p->id) }}"
                                        class="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white text-sm rounded shadow transition">
                                        ✏️ Editar
                                    </a>

                                    {{-- Eliminar --}}
                                    <form id="form-delete-{{ $p->id }}" action="{{ route('admin.instituciones.destroy', $p->id) }}" method="POST"  class="form-eliminar"
